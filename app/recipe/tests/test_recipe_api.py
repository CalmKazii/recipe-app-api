...
def image_upload_url(recipe_id):
    """return url of recipe upload image"""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_retrieve_recipes(self):
        """Test retrieving a list of user"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_bad_request(self):
        """test uploading an inavlid image"""
        url = image_upload_url(self.recipe.id)
    ...
    def test_filter_recipe_by_tags(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='yogurt curry')
        tag1 = sample_tag(user=self.user, name='Vegan')
    ...
    def test_filter_recipes_by_ingredients(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='chicken correander')
